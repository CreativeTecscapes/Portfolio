...
const Footer = () => {
  return (
    <footer class="bg-[#14274E]">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <a href="#">
                <Image height={150} width={150} class="bg-slate-300 rounded-full" src="/CTS-stamp.jpg" alt=""/>
            </a>

            <p class="max-w-md mx-auto mt-4 text-[white]">Design Your Vision Empowered By Our Tech Expertise.</p>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-white">© 2024 Creative Techscapes. All Rights Reserved.</p>
