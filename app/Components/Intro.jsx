...
<div class="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
    ...
    <div
        ...
        <div class="flex flex-col p-12 md:px-16">
            <h2 class="text-2xl font-medium uppercase text-green-800 lg:text-4xl">Creative TechScapes</h2>
            <p class="mt-4 text-lg">
                Design Your Vision Empowered By Our Tech Expertise.
            </p>

            <p class="mt-4 text-justify">
            Creative TechScapes is a leading software development agency specializing in crafting stunning websites, user-friendly mobile apps, advanced AI solutions, and secure blockchain applications. With a focus on creativity and innovation, we deliver tailored digital experiences that engage users, drive results, and shape the future of technology.  
            </p>
