      ...
      <div className="mx-auto max-w-7xl lg:px-8">
        <div className="flex flex-col justify-center px-4 py-10 lg:px-6">
          <div className="inline-flex items-center">
            ...
            <span className="ml-4 text-2xl  text-[#14274E]">Creative Techscapes</span>
          </div>
          ...
          <p className="mt-8 max-w-3xl text-lg text-[#394867]">
            ...
            , We also develop Machine Learning Models and Applications Based on Blockchain.
               ...
               <div className="text navbar-text text-8xl  tracking-wide  flex justify-center p-10 mt-5 mb-5 text-[#14274E]">
